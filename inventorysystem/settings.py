...
SECRET_KEY = 'django-insecure-o+k!ul!ss=+q7(=ke$0l4@08iz3w)^bceh$zs20^gm9!l((8*t'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'base.context_processors.notification',
            ],
        },
    },
]
...
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'joselito.gumban@ctu.edu.ph'
EMAIL_HOST_PASSWORD ='qtya teas wkpz oewi'